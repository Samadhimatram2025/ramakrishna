...
<h1
      ...
      <!-- Sun Animation -->
<p class="quote text-xs text-gray-700 max-w-3xl mt-8 text-center opacity-0 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2" style="font-weight: normal;">
